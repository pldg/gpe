 ...
 *
 * @param {String} [options.placeholder] Placeholder image for *src* attribute.
 * It'll automatically output *data-src* attribute with the fallback `src`.
 *
 * @param {Boolean} [options.ie9] Add conditional comments for Internet
 * Explorer support. Defaults to `false`.
 *
